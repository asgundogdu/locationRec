...
//        <!-- Draw  Date Chart -->
        ...
        x.domain(d3.extent(datedata.map(function(d) {
            return d.date;
        })));
        y.domain([0, d3.max(datedata.map(function(d) {
            return d.freq;
        }))]);
